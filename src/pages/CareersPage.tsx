...
const jobs = [
  {
    ...
    summary: "For CA aspirants seeking mandatory practical training under qualified ICAI mentors.",
    type: "Internship",
    location: "Chennai",
  },
  {
    ...
    summary: "Supporting day-to-day financial operations and bookkeeping for our diverse clients.",
    type: "Full-time",
    location: "Chennai",
  },
  {
    ...
    summary: "Overseeing accounting departments and ensuring excellence in financial reporting.",
    type: "Full-time",
    location: "Chennai",
  },
  {
    ...
    summary: "Leading audit engagement teams and ensuring technical excellence in statutory audits.",
    type: "Full-time",
    location: "Chennai",
  },
  {
    title: "Manager Audit",
    slug: "manager-audit",
    summary: "Strategic oversight of the firm's audit practice and building client relationships.",
    type: "Full-time",
    location: "Chennai",
  },
  {
    ...
    slug: "administration",
    summary: "Managing office operations and facilities to ensure organizational efficiency.",
    type: "Full-time",
    location: "Chennai",
  },
];
        ...
        <div className="container" ref={ref}>
          <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="font-body text-foreground/60 max-w-2xl mx-auto leading-relaxed text-lg">
              Explore professional opportunities and grow your career with a legacy accounting firm.
            </p>
          </div>
          ...
          <div className="mt-12 sm:mt-20 text-center bg-gold/5 rounded-2xl sm:rounded-3xl p-8 sm:p-12 border border-gold/10">
            <h3 className="font-heading text-2xl font-bold text-primary mb-4">Don't see a matching role?</h3>
            <p className="font-body text-foreground/60 mb-8 max-w-xl mx-auto">
              Send us your resume at <a href="mailto:careers@sabapathy.com" className="text-gold font-bold hover:underline">careers@sabapathy.com</a> and we'll keep you updated on future opportunities.
            </p>
          </div>
              ...
              {[
                ...
                <div key={stat.label} className="group px-4">
                  <div className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-2 flex items-center justify-center gap-1">
                    <Counter end={stat.value} trigger={isVisible} duration={2500} />
