...
import { Send, Phone, Mail, Clock, MapPin, Smartphone, ChevronDown } from "lucide-react";
...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <div className="bg-background pt-12 sm:pt-16 lg:pt-24 pb-16 sm:pb-24 lg:pb-32 overflow-hidden relative" ref={ref}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            ...
            <div className={`transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-body text-[11px] font-bold text-gold uppercase tracking-[0.3em]">Contact Information</span>
              </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="group relative p-8 rounded-2xl bg-card border border-border/40 shadow-card hover:border-gold/30 transition-all duration-500 hover:shadow-2xl">
                  ...
                  <div className="relative z-10 flex gap-6">
                    ...
                    <div>
                      <h3 className="font-heading text-xl font-bold text-primary mb-3">Visit Us</h3>
                      <p className="font-body text-sm sm:text-base text-foreground/55 leading-relaxed">
                        New No.81, Old no.47, #139, <br />
                        Dr. Radhakrishnan Salai, Mylapore,<br />
                        Chennai - 600 004
                      </p>
                  ...
                  <div className="relative z-10 flex gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <a href="tel:04435943060" className="block font-body text-lg font-bold text-foreground/75 hover:text-gold transition-colors underline-offset-4 hover:underline">044-35943060</a>
                        <a href="tel:+919840067587" className="block font-body text-lg font-bold text-foreground/75 hover:text-gold transition-colors underline-offset-4 hover:underline">+91 98400 67587</a>
                      </div>
                      <p className="font-body text-[11px] text-gold/60 mt-4 uppercase tracking-widest font-bold">
                ...
                <div className="group relative p-8 rounded-2xl bg-card border border-border/40 shadow-card hover:border-gold/30 transition-all duration-500 hover:shadow-2xl">
                  ...
                  <div className="relative z-10 flex gap-6">
                    ...
                    <div>
                      ...
                      <a href="mailto:sabapathyca@hotmail.com" className="block font-body text-lg font-bold text-foreground/75 hover:text-gold transition-colors underline-offset-4 hover:underline break-all">
                ...
                <div className="relative z-10">
                  ...
                  <form className="space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="font-body text-[11px] font-bold text-primary/60 uppercase tracking-widest ml-1">Your Name</label>
                        <input 
                          type="text" 
                      ...
                      <div className="space-y-2">
                        <label className="font-body text-[11px] font-bold text-primary/60 uppercase tracking-widest ml-1">Email Address</label>
                        <input 
                          type="email" 
                          className="w-full px-6 py-4 rounded-xl bg-background/50 border border-border/50 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-all font-body text-sm placeholder:text-foreground/20" 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                      <div className="space-y-2">
                        <label className="font-body text-[11px] font-bold text-primary/60 uppercase tracking-widest ml-1">Phone Number</label>
                      ...
                      <div className="space-y-2">
                        <label className="font-body text-[11px] font-bold text-primary/60 uppercase tracking-widest ml-1">Query Category</label>
                    ...
                    <div className="space-y-2">
                      <label className="font-body text-[11px] font-bold text-primary/60 uppercase tracking-widest ml-1">Your Query</label>
                      <textarea 
