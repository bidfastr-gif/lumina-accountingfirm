...
const jobDetailsData: Record<string, JobDetail> = {
  "article-assistants": {
    ...
    summary:
      "We are seeking motivated and detail-oriented Article Assistants to join our firm for mandatory practical training as prescribed by ICAI. This role offers hands-on exposure across various domains of Chartered Accountancy under the direct mentorship of experienced partners.",
    responsibilities: [
      {
  ...
  "accounts-assistant": {
    ...
    summary:
      "We are looking for a diligent Accounts Assistant to handle day-to-day accounting operations and provide vital support to our senior finance team. You will be responsible for maintaining accurate financial records and ensuring timely processing of transactions.",
    responsibilities: [
      {
  ...
  "accounts-manager": {
    ...
    summary:
      "The Accounts Manager will oversee the entire accounting function, ensuring accuracy in financial reporting and compliance with all legal and tax regulations. This leadership role requires a strategic thinker who can manage teams and streamline financial processes.",
    responsibilities: [
      {
  ...
  "assistant-manager-audit": {
    ...
    summary:
      "As an Assistant Manager - Audit, you will lead audit engagement teams and be responsible for the end-to-end execution of statutory and internal audits. You will act as a key point of contact for clients and ensure the highest quality of audit output.",
    responsibilities: [
      {
  ...
  "manager-audit": {
    title: "Manager Audit",
    summary:
      "The Audit Manager is a senior leadership position responsible for managing the firm's audit practice. You will be tasked with building client relationships, ensuring technical excellence in audit deliveries, and driving the strategic growth of the audit department.",
    responsibilities: [
      {
  ...
  administration: {
    ...
    summary:
      "The Administration Manager ensures the smooth and efficient operation of our office. You will be responsible for facility management, HR support, procurement, and maintaining a professional environment that enables our technical teams to excel.",
    responsibilities: [
      {
...
const JobDetailsPage = () => {
  ...
  if (!job) {
    return (
      <div className="min-h-screen pt-24 sm:pt-32 flex flex-col items-center justify-center p-6 text-center">
                ...
                <div className="grid md:grid-cols-2 gap-6 sm:gap-10 pl-0 sm:pl-11">
                  {job.responsibilities.map((cat, idx) => (
                    <div key={idx} className="space-y-4">
                      <h3 className="font-heading text-lg font-bold text-primary/80">
                        {idx + 1}. {cat.category}
                      </h3>
                      <ul className="space-y-3">
                        {cat.tasks.map((task, tidx) => (
                          <li
                            key={tidx}
                            className="flex items-start gap-3 text-sm text-foreground/60 font-body"
                          >
              ...
              <section>
                ...
                <ul className="grid sm:grid-cols-2 gap-3 sm:gap-4 pl-0 sm:pl-11">
                  {job.benefits.map((item, idx) => (
                    <li
                      key={idx}
                      className="flex items-center gap-3 p-4 rounded-xl bg-gold/5 border border-gold/10 text-sm text-primary/70 font-medium"
                    >
