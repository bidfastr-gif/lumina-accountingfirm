    ...
    advantages: [
      {
        ...
        description:
          "Customized investment strategies based on your specific financial goals, risk tolerance, and investment horizon.",
      },
      {
        title: "Tax-Efficient Investing",
        description:
          "Structuring investments to minimize tax impact through optimal use of exemptions, deductions, and tax-free instruments.",
      },
      {
        title: "Portfolio Diversification",
        description:
          "Expert guidance on asset allocation across equity, debt, real estate, and alternative investments.",
      },
      {
        title: "Retirement Planning",
        description:
          "Comprehensive planning for financial independence including NPS optimization, pension strategies, and corpus management.",
      },
      {
        title: "Risk Management",
        description:
          "Assessment and mitigation of investment risks through proper diversification and hedging strategies.",
      },
      {
        title: "Regular Monitoring",
        description:
          "Periodic portfolio reviews and rebalancing recommendations to stay aligned with your evolving goals.",
      },
    ],
    process: [
      {
        ...
        description:
          "Comprehensive review of your current financial position, assets, liabilities, and cash flows.",
      },
      {
        step: 2,
        title: "Goal Setting",
        description:
          "Definition of short-term, medium-term, and long-term financial goals with quantified targets.",
      },
      {
        step: 3,
        title: "Strategy Development",
        description:
          "Design of an investment strategy covering asset allocation, product selection, and tax optimization.",
      },
      {
        step: 4,
        title: "Implementation",
        description:
          "Execution support including product selection, documentation, and investment structuring.",
      },
      {
        step: 5,
        title: "Review & Rebalancing",
        description:
          "Periodic portfolio reviews, performance tracking, and rebalancing to remain aligned with goals.",
      },
    ],
    whyChooseUs: [
