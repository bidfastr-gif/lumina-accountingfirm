...
import {
  ...
  GitMerge, ShieldCheck, TrendingUp, Users, ArrowUpRight,
} from 'lucide-react';
...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="py-16 sm:py-20 lg:py-36 overflow-hidden relative">
      {/* Subtle ambient */}
      ...
      <div className="container relative z-10" ref={ref}>
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="font-body text-[11px] font-semibold text-gold/80 uppercase tracking-[0.25em]">Our Services</span>
            <div className="w-10 h-px bg-gold/40" />
          </div>
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-primary mb-4 sm:mb-5">
            Comprehensive <span className="text-gradient-gold">Professional</span> Solutions
          </h2>
          <p className="font-body text-foreground/45 max-w-xl mx-auto leading-relaxed text-[15px]">
            Delivering excellence across audit, taxation, compliance, and strategic advisory with a legacy of trust built over five decades.
          </p>
        </div>
